...
# Procurement Bedrock Agent Deployment Script

set -e

echo "========================================="
echo "Procurement Bedrock Agent Deployment"
echo "========================================="

# Configuration
REGION="us-east-1"
AGENT_NAME="supply-chain-procurement-agent"
MODEL_ID="anthropic.claude-3-5-sonnet-20241022-v2:0"
ROLE_NAME="SupplyChainProcurementAgentRole"
...
if aws iam get-role --role-name $ROLE_NAME 2>/dev/null; then
    ...
    aws iam create-role \
        ...
        --description "IAM role for Supply Chain Procurement Bedrock Agent"
  ...
  "Statement": [
    {
      ...
      "Resource": [
        "arn:aws:lambda:$REGION:$ACCOUNT_ID:function:procurement-*"
      ]
    },
    {
      "Effect": "Allow",
...
LAMBDA_ARN="arn:aws:lambda:$REGION:$ACCOUNT_ID:function:procurement-agent-tools"

aws bedrock-agent create-agent-action-group \
    --region $REGION \
    --agent-id $AGENT_ID \
    --agent-version DRAFT \
    --action-group-name procurement-tools \
...
echo "  --input-text 'Check inventory and create purchase orders for items below reorder point' \\"
echo "  output.txt"
